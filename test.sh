...
assert 20 "main(){int a;a=20;a;}"
assert 35 "main(){int a;int b;a=20;b=15;a+b;}"
assert 35 "main(){int foo;int bar;foo=20;bar=15;foo+bar;}"
assert 14 "main(){int a;int b;a = 3;b = 5 * 6 - 8;return a + b / 2;}"
assert 1  "main(){if (1) 1; else 0;}"
assert 22 "main(){int a;a=0;if (a) 11; else 22;}"
assert 2  "main(){int a;int b;a=0;b=1;if (a) 1; else if (b) 2; else 3;}"
assert 10 "main(){int i; i = 0; while (i < 10) i = i + 1; i;}"
assert 55 "main(){int a; int i; a = 0; for (i = 1; i <= 10; i = i + 1) a = a + i; a;}"
assert 165 "main(){int a; int b; int i; a = 0; b = 0; for (i = 1; i <= 10; i = i + 1) { a = a + i; b = b + i * 2; } a + b;}"
...
assert 100 "echo(x) { int c;c=3;return x; } main(){int a;int b;a=1;b=2;echo(100);}"
